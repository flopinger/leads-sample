                ...
                <CardContent>
                  <div className="space-y-6">
                    ...
                    {gmapsData.about && (gmapsData.about.Angebote || gmapsData.about.Ausstattung || gmapsData.about.Zahlungen) && (
                      ...
                      {gmapsData.about.Zahlungen && Object.keys(gmapsData.about.Zahlungen).length > 0 && (
                        <div>
                          <h4 className="font-medium text-gray-900 mb-3">Zahlungsmethoden</h4>
                          <div className="space-y-2">
                            {Object.entries(gmapsData.about.Zahlungen).map(([method, available]) => (
                              available && (
